...
class disassembler;
struct x86_insn;
enum avx_insn_type_t;

typedef void (disassembler::*BxDisasmPtr_t)(const x86_insn *insn, int op_n);
typedef void (disassembler::*BxDisasmResolveModrmPtr_t)(const x86_insn *insn, unsigned attr, int op_n);

struct BxDisasmOpcodeInfo_t
{
    const char *IntelOpcode;
    avx_insn_type_t avx_opcode;
...
public:
  ...
  x86_insn decode(bx_bool is_32, bx_bool is_64, bx_address base, bx_address ip, const Bit8u *instr);

  x86_insn decode16(bx_address base, bx_address ip, const Bit8u *instr)
    { return decode(0, 0, base, ip, instr); }

  x86_insn decode32(bx_address base, bx_address ip, const Bit8u *instr)
    { return decode(1, 0, base, ip, instr); }

  x86_insn decode64(bx_address base, bx_address ip, const Bit8u *instr)
    { return decode(1, 1, base, ip, instr); }
...
private:
  ...
  void resolve16_mod0   (const x86_insn *insn, unsigned mode, int op_n);
  void resolve16_mod1or2(const x86_insn *insn, unsigned mode, int op_n);

  void resolve32_mod0   (const x86_insn *insn, unsigned mode, int op_n);
  void resolve32_mod1or2(const x86_insn *insn, unsigned mode, int op_n);

  void resolve32_mod0_rm4   (const x86_insn *insn, unsigned mode, int op_n);
  void resolve32_mod1or2_rm4(const x86_insn *insn, unsigned mode, int op_n);

  void resolve64_mod0   (const x86_insn *insn, unsigned mode, int op_n);
  void resolve64_mod1or2(const x86_insn *insn, unsigned mode, int op_n);

  void resolve64_mod0_rm4   (const x86_insn *insn, unsigned mode, int op_n);
  void resolve64_mod1or2_rm4(const x86_insn *insn, unsigned mode, int op_n);
  ...
  void print_memory_access16(int datasize,
          const char *seg, int index, Bit16u disp, int op_b);
  ...
  void set_dsize(int datasize, int op_n);
 ...
 */
  ...
  // far call/jmp
  void Apw(const x86_insn *insn, int op_n);
  void Apd(const x86_insn *insn, int op_n);

  // 8-bit general purpose registers
  void AL_Reg(const x86_insn *insn, int op_n);
  void CL_Reg(const x86_insn *insn, int op_n);

  // 16-bit general purpose registers
  void AX_Reg(const x86_insn *insn, int op_n);
  void DX_Reg(const x86_insn *insn, int op_n);

  // 32-bit general purpose registers
  void EAX_Reg(const x86_insn *insn, int op_n);

  // 64-bit general purpose registers
  void RAX_Reg(const x86_insn *insn, int op_n);
  void RCX_Reg(const x86_insn *insn, int op_n);

  // segment registers
  void CS(const x86_insn *insn, int op_n);
  void DS(const x86_insn *insn, int op_n);
  void ES(const x86_insn *insn, int op_n);
  void SS(const x86_insn *insn, int op_n);
  void FS(const x86_insn *insn, int op_n);
  void GS(const x86_insn *insn, int op_n);

  // segment registers
  void Sw(const x86_insn *insn, int op_n);

  // test registers
  void Td(const x86_insn *insn, int op_n);

  // control register
  void Cd(const x86_insn *insn, int op_n);
  void Cq(const x86_insn *insn, int op_n);

  // debug register
  void Dd(const x86_insn *insn, int op_n);
  void Dq(const x86_insn *insn, int op_n);

  //  8-bit general purpose register
  void Reg8(const x86_insn *insn, int op_n);

  // 16-bit general purpose register
  void RX(const x86_insn *insn, int op_n);

  // 32-bit general purpose register
  void ERX(const x86_insn *insn, int op_n);

  // 64-bit general purpose register
  void RRX(const x86_insn *insn, int op_n);

  // general purpose register or memory operand
  void Eb(const x86_insn *insn, int op_n);
  void Ew(const x86_insn *insn, int op_n);
  void Ed(const x86_insn *insn, int op_n);
  void Eq(const x86_insn *insn, int op_n);
  void Ey(const x86_insn *insn, int op_n);
  void Ebd(const x86_insn *insn, int op_n);
  void Ewd(const x86_insn *insn, int op_n);
  void Edq(const x86_insn *insn, int op_n);

  // general purpose register
  void Gb(const x86_insn *insn, int op_n);
  void Gw(const x86_insn *insn, int op_n);
  void Gd(const x86_insn *insn, int op_n);
  void Gq(const x86_insn *insn, int op_n);
  void Gy(const x86_insn *insn, int op_n);

  // vex encoded general purpose register
  void By(const x86_insn *insn, int op_n);

  // immediate
  void I1(const x86_insn *insn, int op_n);
  void Ib(const x86_insn *insn, int op_n);
  void Iw(const x86_insn *insn, int op_n);
  void Id(const x86_insn *insn, int op_n);
  void Iq(const x86_insn *insn, int op_n);

  // double immediate
  void IbIb(const x86_insn *insn, int op_n);
  void IwIb(const x86_insn *insn, int op_n);

  // sign extended immediate
  void sIbw(const x86_insn *insn, int op_n);
  void sIbd(const x86_insn *insn, int op_n);
  void sIbq(const x86_insn *insn, int op_n);
  void sIdq(const x86_insn *insn, int op_n);

  // floating point
  void ST0(const x86_insn *insn, int op_n);
  void STi(const x86_insn *insn, int op_n);

  // general purpose register
  void Rw(const x86_insn *insn, int op_n);
  void Rd(const x86_insn *insn, int op_n);
  void Rq(const x86_insn *insn, int op_n);
  void Ry(const x86_insn *insn, int op_n);

  // mmx register
  void Pq(const x86_insn *insn, int op_n);

  // mmx register or memory operand
  void Qd(const x86_insn *insn, int op_n);
  void Qq(const x86_insn *insn, int op_n);
  void Vq(const x86_insn *insn, int op_n);
  void Nq(const x86_insn *insn, int op_n);

  // xmm/ymm register
  void Ups(const x86_insn *insn, int op_n);
  void Upd(const x86_insn *insn, int op_n);
  void Udq(const x86_insn *insn, int op_n);
  void Uq(const x86_insn *insn, int op_n);

  void Vdq(const x86_insn *insn, int op_n);
  void Vss(const x86_insn *insn, int op_n);
  void Vsd(const x86_insn *insn, int op_n);
  void Vps(const x86_insn *insn, int op_n);
  void Vpd(const x86_insn *insn, int op_n);
  // xmm/ymm register through imm byte
  void VIb(const x86_insn *insn, int op_n);

  // xmm/ymm register or memory operand
  void Wb(const x86_insn *insn, int op_n);
  void Ww(const x86_insn *insn, int op_n);
  void Wd(const x86_insn *insn, int op_n);
  void Wq(const x86_insn *insn, int op_n);

  void Wdq(const x86_insn *insn, int op_n);
  void Wss(const x86_insn *insn, int op_n);
  void Wsd(const x86_insn *insn, int op_n);
  void Wps(const x86_insn *insn, int op_n);
  void Wpd(const x86_insn *insn, int op_n);

  // vex encoded xmm/ymm register
  void Hdq(const x86_insn *insn, int op_n);
  void Hps(const x86_insn *insn, int op_n);
  void Hpd(const x86_insn *insn, int op_n);
  void Hss(const x86_insn *insn, int op_n);
  void Hsd(const x86_insn *insn, int op_n);

  // direct memory access
  void OP_O(const x86_insn *insn, unsigned size, int op_n);
  void Ob(const x86_insn *insn, int op_n);
  void Ow(const x86_insn *insn, int op_n);
  void Od(const x86_insn *insn, int op_n);
  void Oq(const x86_insn *insn, int op_n);

  // memory operand
  void OP_M(const x86_insn *insn, unsigned size, int op_n);
  void Ma(const x86_insn *insn, int op_n);
  void Mp(const x86_insn *insn, int op_n);
  void Ms(const x86_insn *insn, int op_n);
  void Mx(const x86_insn *insn, int op_n);
  void Mb(const x86_insn *insn, int op_n);
  void Mw(const x86_insn *insn, int op_n);
  void Md(const x86_insn *insn, int op_n);
  void Mq(const x86_insn *insn, int op_n);
  void Mt(const x86_insn *insn, int op_n);
  void Mdq(const x86_insn *insn, int op_n);
  void Mps(const x86_insn *insn, int op_n);
  void Mpd(const x86_insn *insn, int op_n);
  void Mss(const x86_insn *insn, int op_n);
  void Msd(const x86_insn *insn, int op_n);

  // gather VSib
  void VSib(const x86_insn *insn, int op_n);

  // string instructions
  void OP_X(const x86_insn *insn, unsigned size, int op_n);
  void Xb(const x86_insn *insn, int op_n);
  void Xw(const x86_insn *insn, int op_n);
  void Xd(const x86_insn *insn, int op_n);
  void Xq(const x86_insn *insn, int op_n);

  // string instructions
  void OP_Y(const x86_insn *insn, unsigned size);
  void Yb(const x86_insn *insn, int op_n);
  void Yw(const x86_insn *insn, int op_n);
  void Yd(const x86_insn *insn, int op_n);
  void Yq(const x86_insn *insn, int op_n);

  // maskmovdq/maskmovdqu
  void OP_sY(const x86_insn *insn, unsigned size);
  void sYq(const x86_insn *insn, int op_n);
  void sYdq(const x86_insn *insn, int op_n);

  // jump offset
  void Jb(const x86_insn *insn, int op_n);
  void Jw(const x86_insn *insn, int op_n);
  void Jd(const x86_insn *insn, int op_n);
};
